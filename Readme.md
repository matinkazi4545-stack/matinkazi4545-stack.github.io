...
<body>
    ...
    <nav class="navbar">
        <ul>
            ...
            <li><a href="resume.html" target="_self" onclick="window.location.href='resume.html'; return false;">Resume</a></li>
        ...
        <div class="container header-container">
            ...
            <div class="header-text">
                ...
                <div class="buttons-container">
                    ...
                    <a href="#" class="btn my-works">My Works</a>
        ...
        <div class="container">
            ...
            <div class="about-content">
                ...
                <div class="about-details">
                    ...
                    <br/>
                    <a href="resume.html" target="_self" class="btn download-cv">Download CV</a>
                </div>
            </div>
        </div>
    </section>
